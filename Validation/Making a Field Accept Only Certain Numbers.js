...
/* Note: In the curly brackets is the number of digits the value will have, so it's very important to have this updated to match the maximum amount of digits 
out of the field's options!
*/
var re = /([###]{#})/
